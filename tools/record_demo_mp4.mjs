...
const output = path.join(root, "docs", "demo-video", "evidencelock-sift-demo.mp4");
...
async function encodeFrames(page, frames, narrationDataUrl) {
  return page.evaluate(
    async ({ frames: frameUrls, narrationDataUrl, width, height, holdSeconds, fps }) => {
      ...
      if (!mimeType) throw new Error("No supported MediaRecorder MP4 MIME type is available.");
