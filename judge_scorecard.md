...
| Usability and documentation | Judges get a static hub, a two-minute judge pack, a standard-library quickstart, gallery assets, and Devpost-ready field text. | `docs/index.html`; `docs/judge_pack.md`; `README.md` |
